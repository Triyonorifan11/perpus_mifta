                ...
                <div class="card-body">
                    <form method="POST">
                        <div class="row g-3 align-items-center mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="nama" id="Nama" class="form-control" aria-describedby="passwordHelpInline" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-center mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="telepon" id="telepon" class="form-control" aria-describedby="passwordHelpInline" required>
                            </div>
                        </div>
