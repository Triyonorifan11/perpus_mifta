...
<body>
    ...
    <nav class="navbar navbar-expand-lg shadow-sm" style="background-color: white;">
        <div class="container-fluid container">
            <a class="navbar-brand me-4 fs-3" href="dashboard.php?user=<?= $id ?>"><i class="bi bi-house-door"></i></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <h5 class="me-4"><?php if (isset($_SESSION["email"])) {
                ...
                <div class="dropdown">
                    ...
                    <?php if (isset($_SESSION["email"])) : ?>
                        <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="dropdownMenu2">
                            ...
                            <li><a href="resetPasword.php?user=<?= $id; ?>" class="dropdown-item">Reset Password</a></li>
